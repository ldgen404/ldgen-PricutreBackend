...
import com.ldgen.ldgenpricutrebackend.model.dto.user.*;
...
/**
 * @class: com.ldgen.ldgenpricutrebackend.controller.UserController
 * @author: LBigGen
 * @create: 2025-03-04 20:54
 */
@RestController
@RequestMapping("/user")
public class UserController {
     ...
     * 用户注册
     *
     * @param userRegisterRequest 用户传来的用户信息
     * @return 用户注册
     */
