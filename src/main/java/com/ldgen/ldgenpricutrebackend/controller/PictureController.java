...
//        String redisKey = "Ldgencture:listPictureVOByPage:" + hashKey;
        // 从 Redis 缓存中查询
        // 构建缓存 key
...
//        String cachedValue = valueOps.get(redisKey);
        ...
        System.out.println("生成的 SQL：" + queryWrapper.getSqlSegment());
        System.out.println("查询条件：" + pictureQueryRequest);
        // 获取封装类
